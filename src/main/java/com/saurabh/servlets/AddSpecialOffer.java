...
import com.saurabh.entities.AddSpecialOfferInfo;
import com.saurabh.validity.ValidityChecker;

/**
 * Servlet implementation class AddSpecialOffer
 */
@WebServlet("/AddSpecialOffer")
@MultipartConfig
public class AddSpecialOffer extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSpecialOffer() {
        super();
...
Integer adminID=(Integer)request.getSession().getAttribute("adminid");
	...
	private boolean setValues(HttpServletRequest request) throws IOException, ServletException {
		...
		{
			AddSpecialOfferInfo api=new AddSpecialOfferInfo();
			...
			api.setInformation(information);
