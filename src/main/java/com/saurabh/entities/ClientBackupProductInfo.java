...
@Entity
public class ClientBackupProductInfo {
	
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private int clientBackupProductId;
...
private String productCompany;
	...
	public int getClientBackupProductId() {
		return clientBackupProductId;
	}
	public void setClientBackupProductId(int clientBackupProductId) {
		this.clientBackupProductId = clientBackupProductId;
	}
