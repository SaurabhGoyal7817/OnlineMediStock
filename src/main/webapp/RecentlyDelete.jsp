...
<%
List<BackupProductInfo> list=ValidityChecker.getValidityChecker().getListBackupProductInfo();
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Recently Delete Product</title>
...
<br>
<h3 style="margin:20px;">Recently Delete Product</h3>
...
<br>
		...
		<%int i=1;
		for(BackupProductInfo api:list)
		{%>
		<tbody>
		...
		<td><a class="btn btn-outline-light btn-lg bg-danger" href="PerDeleteProduct?perdeleteid=<%=api.getBackupProductId()%>">Delete</a></td>
	    <td><a class="btn btn-outline-light btn-lg bg-success" href="RestoreProduct?restoreid=<%=api.getBackupProductId()%>">Restore</a></td>
		</tr>
