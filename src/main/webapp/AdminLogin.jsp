...
<div class="card-body">
<form id="logform" action="LoginAdmin" method="POST">
  <div class="form-group">
    <label for="email">Email</label>
    <input type="email" name="email" class="form-control" id="adminid" aria-describedby="adminidHelp" placeholder="abc@opq.xyz">
		...
		({
			...
			success:function(data,textStatus,jqXHR){
				...
				if(data.trim()==='done')
				{
					...
					swal("Welcome!", "", "success").then((value)=>{
